...
uint16_t adcValue = 0;                //eger derleyicinin dedigi gibi static yaparsan baska dosyalarda kullanilamadigi için STM STUDIO'da hata veriyor
